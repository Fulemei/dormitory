					...
					<c:choose>
						<c:when test="${order.status==0}">
							<div>
								...
								<div class="button-group border-red float-right">
									<button type="button" class="button active rec-btn float-right" id="${order.oid}"> 未受理</button>
								</div>
							</div>
						</c:when>
						<c:when test="${order.status==1}">
							<div>
								...
								<div class="button-group border-red float-right">
									<button type="button" class="button active rec-btn float-right" id="${order.oid}">已受理</button>
								</div>
							</div>
						</c:when>
						<c:when test="${order.status==2}">
							<div>
								...
								<div class="button-group border-red float-right">
									<button type="button" class="button active rec-btn float-right" id="${order.oid}"> 受理完成</button>
								</div>
							</div>
						</c:when>
