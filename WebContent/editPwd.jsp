		...
		<div class="contain float-right">
			...
			<input type="hidden" name="method" value="updatePassword"/>
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="password" class="input" id="newPass" name="newPass" size="30" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<input type="password" class="input" id="repass" name="repass" size="30" data-validate="repeat#newPass:两次输入的密码不一致" />
					</div>
				</div>
				<br>
