						...
						submitHandler: function(form) {
							...
							$.post(postUrl,param,function(data){
								if(data.state){
									//执行跳转
									layer.msg("报修成功~");
									window.location.href='MyOrderServlet'
								}else{
									layer.msg(data.msg);
								}
							},"json");
		...
		<div class="contain float-right">
			...
			<input type="hidden" name="method" value="createOrder"/>
				<div class="form-group">
					...
					<div class="field">
						<input type="text" value="${sessionUser.name}" class="input" id="name" name="name" size="40" data-validate="required:必填" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<input type="text" value="${sessionUser.tel_number}" class="input" id="tel_number" name="tel_number" size="30" data-validate="required:必填,mobile:请输入正确手机号码" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<textarea rows="2" class="input" id="address" name="address" data-validate="required:必填">${sessionUser.dormitory}</textarea>
					</div>
				</div>
				<div class="form-group">
					<div class="label">
